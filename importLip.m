function Untitled = importLip(filename, startRow, endRow)
...
%
% Example:
%   Untitled = importfile('2015-10-20_15-11-18.tx0', 275, 844);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/16 13:55:13
...
if length(next)>570
    ...
    for i= 1:length(next)
        ...
        if next(i,2)<61 && next(i,3)<61 && next(i,4)<61 && next(i,5)<61
            closer(cnt,:) = next(i,:);
            cnt = cnt+1;
        end
    end
