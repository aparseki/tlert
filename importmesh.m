...
%   MESH1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   MESH1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   mesh1 = importfile('mesh.dat', 1, 10579);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/11/30 21:49:39
